...
public class TypeCastingManager : MonoBehaviour
{
    [Header("UI Elements")]
    ...
    {
        Popup = GameObject.Find("Canvas/Popups/TypeCasting");
    ...
    public void ApplyUpcasting()
    {
        ...
        currentCharacter.UpcastMethod.TypeCastingTrackerManager.ToggleOn();
    ...
    {
        SceneManagement.ScenePause("TypeCastingManager");
    ...
    {
        SceneManagement.SceneResume("TypeCastingManager");
