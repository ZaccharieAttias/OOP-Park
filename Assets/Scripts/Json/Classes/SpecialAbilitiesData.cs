...
public static class SpecialAbilitiesData
{
    ...
    {
        File.WriteAllText(FilePath, Serialize(SpecialAbilityManager.SpecialAbilitiesDictionary));
    }
    public static void Load()
    {
        SpecialAbilityManager.SpecialAbilitiesCollection = Deserialize(File.ReadAllText(FilePath));
    }
    public static void Load(string filename)
    {
        SpecialAbilityManager.SpecialAbilitiesCollection = Deserialize(File.ReadAllText(filename));
    }
    public static string Serialize(Dictionary<SpecialAbilityType, List<SpecialAbility>> specialAbilities)
    {
        return JsonConvert.SerializeObject(specialAbilities, Formatting.Indented);
    }
