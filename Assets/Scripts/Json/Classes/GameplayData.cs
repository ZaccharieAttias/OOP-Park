...
public static class GameplayData
{
    ...
    {
        File.WriteAllText(FilePath, Serialize(SceneManagement.GameplayInfo));
    }
    public static void Load()
    {
        SceneManagement.GameplayInfo = Deserialize(File.ReadAllText(FilePath));
    }
    ...
    {
        return JsonConvert.SerializeObject(gameplayInfos, Formatting.Indented);
    }
    public static List<GameplayInfo> Deserialize(string json)
    {
        return JsonConvert.DeserializeObject<List<GameplayInfo>>(json);
    }
}