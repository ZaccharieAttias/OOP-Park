...
public class WallJump : PowerupEffect
{
    ...
    public override void plusActivatePower(GameObject player) { player.GetComponent<Movement>().MaxWallJumps += 100; }

    public override void plusDeactivatePower(GameObject player) { player.GetComponent<Movement>().MaxWallJumps -= 100; }
